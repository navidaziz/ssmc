...
class Test_group_tests extends Admin_Controller{
    ...
    $this->data["tests"] = $this->test_group_test_model->getList("tests", "test_id", "test_name", $where ="`tests`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Add New Test Group Test');$this->data["view"] = ADMIN_DIR."test_group_tests/add_test_group_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------
    ...
    $this->data["tests"] = $this->test_group_test_model->getList("tests", "test_id", "test_name", $where ="`tests`.`status` IN (1) ");
        ...
        $this->data["title"] = $this->lang->line('Edit Test Group Test');$this->data["view"] = ADMIN_DIR."test_group_tests/edit_test_group_test";
        $this->load->view(ADMIN_DIR."layout", $this->data);
     }
     //--------------------------------------------------------------------

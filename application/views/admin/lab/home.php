        ...
        <div class="content">
            ...
            <div class="btn-group">
                <a href="<?php echo site_url(ADMIN_DIR . $this->session->userdata("role_homepage_uri")); ?>"
                    class="btn btn-danger"><i class="fa fa-chevron-left"></i> Go Back</a>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        title="<?php echo $system_global_settings[0]->system_title ?>" class="img-responsive " style="width:40px !important;"></a>-->
                                    <h4 style="margin-top: -5px;">
                                        <strong><?php echo $system_global_settings[0]->system_title ?></strong>
                                    </h4>
                                    <h5 style="margin-top: -5px;">Chitral</h5>
                                </td>
                                <td>
                                    <ul class="nav navbar-nav pull-right" style="margin-top: -20px;">
                                        <li style="float:right" class="dropdown user" id="header-user"> <a href="#"
                                                ...
                                                <span
                                                    class="username"><?php echo $this->session->userdata("user_title"); ?></span>
                                                <i class="fa fa-angle-down"></i> </a>
                                            <ul class="dropdown-menu">
                                                <li><a
                                                        href="<?php echo site_url(ADMIN_DIR . "users/update_profile"); ?>"><i
                                                            class="fa fa-user"></i> Update Profile</a></li>
                                                <li><a href="<?php echo site_url(ADMIN_DIR . "users/logout"); ?>"><i
              ...
              <td><?php echo $test->total_price; ?></td> -->
                  ...
                  AND `invoice_test_groups`.`invoice_id` = '" . $test->invoice_id . "'";
                    ...
                    ?>
                                    ...
                                    <input id="in_<?php echo $test->invoice_id; ?>" type="hidden"
                                        value="<?php echo @$other_info; ?>" />
                                    <input id="patient_group_test_ids_<?php echo $test->invoice_id; ?>" type="hidden"
                                        value="<?php echo @$patient_group_test_ids; ?>" />
                                    <a href="#"
                                        onclick="test_token('<?php echo $test->invoice_id; ?>', '<?php echo $test->patient_name;  ?>', '', '<?php echo $test->test_token_id;  ?>' )">Process</a>
                                    <?php  } ?>
            ...
            <div class="col-md-12">
              ...
              <td><?php echo $test->total_price; ?></td>-->
                                <td>
                                    ...
                                    <a href="#" onclick="get_patient_test_form('<?php echo $test->invoice_id; ?>')">Add
                                        Result</a>
            ...
            <div class="col-md-12">
              ...
              <td><?php echo $test->total_price; ?></td>-->
                                <td>
                                    ...
                                    <a href="#" onclick="get_patient_test_form('<?php echo $test->invoice_id; ?>')">Edit
                                        Result</a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="information_model_body" style="text-align:center !important">
                ...
                <form onsubmit="return validate_token()"
                    action="<?php echo site_url(ADMIN_DIR . 'lab/save_and_process') ?>" method="post">
                    ...
                    <input required="required" placeholder="Enter test token ID" type="text" name="test_token_id"
                        id="test_token_id" value="" />
...
<link rel="stylesheet" type="text/css"
    href="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/jquery.dataTables.css") ?>">

<script type="text/javascript" charset="utf8"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/jquery.dataTables.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/dataTables.buttons.min.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/jszip.min.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/pdfmake.min.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/vfs_fonts.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/buttons.html5.min.js") ?>"></script>
<script type="text/javascript" language="javascript"
    src="<?php echo site_url("assets/" . ADMIN_DIR . "other_files/buttons.print.min.js") ?>"></script>

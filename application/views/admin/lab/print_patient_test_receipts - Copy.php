        ...
        <div style="padding: 0px;" contenteditable="tr ue">
            <div style="text-align: center; padding-top: 10px;">
                ...
                <small style="font-size: 12px;">Chinar Inn Market Shahi Bazar Near Ataliq, Bridge Chitral
                    <br /> PHONE <?php echo $system_global_settings[0]-> phone_number; ?></small>
                <br />
                <strong style="font-size: 12px;">RECEIPT NO: <?php echo $invoice_detail->invoice_id; ?> <br /> Token NO:
                    <?php echo $invoice_detail->test_token_id; ?></strong>
                                    ...
                                    <td>
                                        ...
                                        <div style="margin: 5px; padding:5px; ">
                                            <table class="table table-bordered"
                                                style="text-align: left; font-size: 15px !important;">
                                                <tr>
                                                    <th>#</th>
                                                    <th>Details</th>
                                                    <th>Amount</th>

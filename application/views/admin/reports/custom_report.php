...
<body>
    <page size='A4'>
        <div style="padding: 5px;  padding-left:20px; padding-right:20px; " contenteditable="true">
            ...
            <h4 style="text-align: center;">Customize Report ( Date:
                <?php echo date("d F, Y ", strtotime($start_date)) ?> to
                <?php echo date("d F, Y ", strtotime($end_date)) ?>)</h4>
        ...
        foreach ($income_from_drs as $report) { ?>
            ...
            ?>
                        Total Sale:
                        <?php echo ($today_sale_summary->total_sale) ? $today_sale_summary->total_sale : 0; ?> Rs.<br />
                        Sale Total Profit:
                        <?php echo ($today_sale_summary->total_profit) ? $today_sale_summary->total_profit : 0; ?> Rs.
                    </td>
                    <td>

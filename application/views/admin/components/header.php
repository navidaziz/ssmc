...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url("assets/" . ADMIN_DIR . "css/responsive.css"); ?>"
        media="screen,print" />
    <link rel="stylesheet" type="text/css"
        href="<?php echo site_url("assets/" . ADMIN_DIR . "css/jquery-ui.css"); ?>" />
    <script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo site_url("assets/" . ADMIN_DIR . "css/print.css"); ?>"
        media="print" />
...
<body>
    ...
    <header class="navbar clearfix" id="header">
        ...
        ?>
                <a href="<?php echo site_url(ADMIN_DIR . $this->session->userdata("role_homepage_uri")); ?>"> <img
                        src="<?php echo site_url("assets/uploads/" . $log); ?>"
    ...
    ?>
        <div id="main-content" <?php if (in_array($this->router->fetch_class(), $wide_page)) { ?> class="margin-left-50"
            <?php } ?>>
            <div class="container">
                <div class="row">

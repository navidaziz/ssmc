...
<table class="table1 table1-bordered1" style="width: 100% !important;">
    <thead>
        <tr>
            <th colspan="5">
                <h4 style="text-align: center;"><?php echo $system_global_settings[0]->system_title ?> Chitral</h4>
                <h6 style="text-align: center; font-size: 11px;"><?php echo $system_global_settings[0]->address; ?>
                    <br /> PHONE <?php echo $system_global_settings[0]-> phone_number; ?>
                </h6>
                <div id="sale_id">
                    <?php if ($sale->return) { ?> <span style="color: black;">Return</span> <?php } else { ?> <span
                        style="color: black;">Sale</span> <?php } ?> -


                    Receipt No: <strong><?php echo $sale->sale_id; ?></strong></div>
                <div id="employee">Customer: <?php echo $sale->customer_name; ?>
                    <?php echo "- " . $sale->customer_mobile_no; ?></strong> </div>
            ...
            <td colspan="5">
                <small>
                    <p style="text-align: center;"> Date:
                        <?php echo date('d M, y - h:i A', strtotime($sale->created_date)); ?> -----
